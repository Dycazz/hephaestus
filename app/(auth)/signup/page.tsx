    ...
    <PageShell>
      {sent ? (
        <div className="text-center py-4">
          ...
          <p className="text-sm text-white/60 mb-1">A new verification link has been sent to</p>
          <p className="text-sm font-semibold text-white mb-4 break-all">{email}</p>
          <p className="text-xs text-white/40">Click the link in the email to verify your account.</p>
        </div>
      ) : (
        <>
          <div className="mb-6">
            <div className="inline-flex items-center gap-1.5 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 text-xs font-semibold text-red-200 mb-3">
              Link expired
            </div>
            <h2 className="text-xl font-semibold text-white mb-1">Verification link expired</h2>
            <p className="text-sm text-white/60">Enter your email to receive a new confirmation link.</p>
          </div>
          ...
          <form onSubmit={handleResend} className="space-y-4">
            ...
            >
              {loading ? <><Loader2 className="inline h-4 w-4 animate-spin mr-1" />Sending…</> : 'Resend verification email'}
            </button>
          </form>
