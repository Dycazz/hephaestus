          ...
          <div className="space-y-6">
            ...
            {appointments.filter((a) => a.status === 'completed').length === 0 && (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <div className="h-16 w-16 rounded-full bg-[rgba(44,52,64,0.2)] flex items-center justify-center mb-4 border border-[rgba(44,52,64,0.3)]">
                  <CheckCircle className="w-8 h-8 text-[rgba(44,52,64,0.4)]" />
                </div>
